...
public class NewSampleThreatFamilyTests
{
    ...
    [InlineData(@"KrobusCourier\KrobusCourier.dll.di", "family-webdownload-stage-exec-v3", "webdownload-temp-hidden-launch-generic")]
    ...
    [InlineData(@"KrobusCourier\KrobusCourier.dll.di", "family-webdownload-stage-exec-v3")]
