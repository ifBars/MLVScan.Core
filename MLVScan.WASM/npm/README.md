...
| `getScannerVersion()` | `Promise<string>` | Scanner engine version, such as `"1.7.1"`. Returns `"1.0.0-mock"` in mock mode. |
| `getSchemaVersion()` | `Promise<string>` | Result schema version, currently `"1.4.0"`. |
