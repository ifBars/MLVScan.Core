...
export type AnalysisCompletenessStatus = 'Complete' | 'Partial' | 'Incomplete'
...
export type ThreatDispositionClassification = 'Clean' | 'ManualReviewRequired' | 'Suspicious' | 'KnownThreat'
...
export interface AnalysisCompleteness {
  ...
  reasons: AnalysisCompletenessReason[]
}

export interface AnalysisCompletenessReason {
  reasonId: string
  summary: string
  phase?: string | null
  ruleId?: string | null
